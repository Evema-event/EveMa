...
let eventData = {
    ...
    "registeredStalls": ["5f5b245a9bf8ea0514021722", "5f5b24649bf8ea0514021724", "5f5b2ef538456b0017a315e3", "5f5b2f3038456b0017a315e5"],
    "registeredConferences": ["5f5b1be09bf8ea0514021711", "5f5b24909bf8ea0514021725", "5f5b2ffc38456b0017a315e6"],
...
describe('Test cases Events in the home page', () => {
    ...
    test('Should render description of event two time', () => {
        const description = screen.getAllByText(eventData.description.slice(0, 100));
    ...
    test('Should render startDate of event two time', () => {
        const startDate = screen.getAllByText(new Date(eventData.startDate).toISOString().slice(0, 10));
