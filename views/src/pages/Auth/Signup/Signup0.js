                    ...
                    <span className={classes['inputs']}>
                        ...
                        <div>
                            {loading ? (
                                <button
                                    type='button'
                                    className={['btn', 'btn-primary', 'btn-block', classes.link, classes.next, classes['btn-primary']].join(' ')}
                                ...
                                >
                                    ...
                                    <button
                                        data-testid='button'
                                        type='submit'
                                        className={['btn btn-primary btn-block', classes['btn-primary'], classes.next, classes.link].join(' ')}
                                    >
                                        Next
                                    </button>
                                )}
